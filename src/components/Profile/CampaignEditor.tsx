...
export default function CampaignEditor() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      await createCampaign(campaignData, files.map(f => f.file));
    ...
    <div className="flex h-screen bg-gray-50">
      ...
      <main className="flex-1 overflow-y-auto">
        <div className="container mx-auto px-6 py-8">
          <h1 className="text-2xl font-semibold text-gray-900 mb-8">Create campaign</h1>
          ...
          <form onSubmit={handleSubmit} className="max-w-2xl">
            <div className="space-y-6">
              ...
              <FormField label="Campaign due date" error={errors.dueDate} required>
                <input
                  type="date"
                  name="dueDate"
              ...
              <FormField label="Requirements" error={errors.requirements} required>
                <textarea
                  name="requirements"
