  ...
  return (
    <div className="min-h-screen bg-[#1d4e74] flex flex-col items-center justify-center p-4">
      ...
      <div className="w-full max-w-md bg-white rounded-2xl shadow-xl p-8">
        <h2 className="text-3xl font-semibold text-[#1d4e74] mb-6 text-center">
          Sign up
        </h2>
        ...
        <form onSubmit={handleSubmit} className="space-y-4">
          <FormField label="Full name" error={errors.fullName} required>
            <input
              ...
              } rounded-md shadow-sm focus:outline-none focus:ring-2 focus:ring-[#1d4e74] focus:border-transparent`}
          ...
          <p className="text-center text-sm text-gray-600 mt-4">
            ...
            <Link
              to="/login"
              className="text-[#1d4e74] hover:text-[#163a57] font-medium"
            >
              Log in
            </Link>
          </p>
